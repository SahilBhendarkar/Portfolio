              ...
              <div className="p-6 md:p-8 flex flex-col flex-grow space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5 pt-2 flex-grow">
                  {project.techStack.slice(0, 4).map((tech, i) => (
                    <span 
                      key={i}
                      className="text-xs bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 rounded-full px-3 py-1 font-mono font-medium"
                    >
                      {tech}
                    </span>
                  ))}
                  {project.techStack.length > 4 && (
                    <span className="text-xs bg-primary-100 dark:bg-primary-950/20 text-primary-600 dark:text-primary-400 border border-primary-200/50 dark:border-primary-800/30 rounded-full px-2.5 py-1 font-semibold">
